...
| :--- | :---: | :--- |
| **Financial Forecasting (RNN)** | `TensorFlow` `Python` | **[View Project](https://github.com/YOUR_USERNAME/financial-forecasting-rnn)**<br>Comparative analysis of RNN, LSTM, and GRU architectures on 10 years of stock data. |
